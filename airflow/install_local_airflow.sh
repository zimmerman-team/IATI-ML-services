...
pip install cython torchvision ipython hiddenlayer matplotlib seaborn apache-airflow psycopg2 numpy sklearn pymongo torch mlflow gensim nltk pytorch_lightning ray wandb higher
