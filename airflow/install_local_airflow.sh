...
pip install cython torchvision ipython hiddenlayer matplotlib seaborn apache-airflow apache-airflow[postgres] psycopg2 numpy sklearn pymongo torch mlflow gensim nltk pytorch_lightning ray wandb higher billiard statsd npyscreen
